...
public class WorkflowReportJob {
    ...
    public WorkflowReportJob(String name, String label, String failuresAnchor, GHWorkflowRun.Conclusion conclusion, String failingStep,
    ...
    public boolean isFailing() {
        return !GHWorkflowRun.Conclusion.SUCCESS.equals(conclusion) &&
                !GHWorkflowRun.Conclusion.SKIPPED.equals(conclusion);
    }

    public boolean isSkipped() {
        return GHWorkflowRun.Conclusion.SKIPPED.equals(conclusion);
    }
    ...
    public boolean hasTestFailures() {
        int i = 0;
        System.out.println("models length = " + modules.size());
        for (WorkflowReportModule module : modules) {
        ...
        System.out.println("model is false " + i);
        return false;
    }
