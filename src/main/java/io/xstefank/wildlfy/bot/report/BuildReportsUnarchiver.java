...
@ApplicationScoped
public class BuildReportsUnarchiver {
    ...
    public Optional<BuildReports> getBuildReports(WorkflowContext workflowContext,
        ...
        try {
            ...
            LOG.warn(" - Unable to download the artifacts in a timely manner, ignoring them");
    ...
    private static class ArtifactIsDownloaded implements Callable<Boolean> {
        ...
        public Boolean call() {
            try {
                ...
                LOG.error(" - Unable to download artifact " + buildReportsArtifact.getName() +
                        "- retry #" + retry, e);
                return false;
            }
        }
